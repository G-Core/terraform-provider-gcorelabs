...
* `gcloud/gcorecloud-go/openstack/compute/v2/extensions/floatingip` is now `gcloud/gcorecloud-go/openstack/compute/v2/extensions/floatingips`
...
* `Token.ExpiresAt` is now of type `gcorecloud.JSONRFC3339Milli` instead of
  `time.Time`
