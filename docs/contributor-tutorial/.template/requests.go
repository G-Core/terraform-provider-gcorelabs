...
func (opts CreateOpts) ToResourceCreateMap() (map[string]interface{}, error) {
	return gcorecloud.BuildRequestBody(opts, "resource")
}
...
func Create(client *gcorecloud.ServiceClient, opts CreateOptsBuilder) (r CreateResult) {
	...
	_, r.Err = client.Post(createURL(client), &b, &r.Body, &gcorecloud.RequestOpts{
		OkCodes: []int{201},
	})
	return
}
...
func Delete(client *gcorecloud.ServiceClient, id string) (r DeleteResult) {
...
func Update(client *gcorecloud.ServiceClient, id string, opts UpdateOptsBuilder) (r UpdateResult) {
	...
	_, r.Err = client.Patch(updateURL(client, id), b, &r.Body, &gcorecloud.RequestOpts{
		OkCodes: []int{200},
	})
	return
}
